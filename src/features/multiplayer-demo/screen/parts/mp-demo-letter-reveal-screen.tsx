/**
 * Demo Letter Reveal Screen
 *
 * Dramatic letter reveal with bounce animation
 */
...
export function MPDemoLetterRevealScreen() {
  const { setGameState, letter } = useMultiplayerDemoContext();

  useEffect(() => {
    const stopSound = soundService.playLetterReveal();

    const timer = setTimeout(() => {
      setGameState(MultiplayerDemoState.ANSWERING);
    }, 2500);
