/**
 * Multiplayer Roulette Screen
 *
 * Spins the roulette to select the letter (matches single-player design)
 */
...
interface MPRouletteScreenProps {
  onComplete: () => void;
}

export function MPRouletteScreen({ onComplete }: MPRouletteScreenProps) {
